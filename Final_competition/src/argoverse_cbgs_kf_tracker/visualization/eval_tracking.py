...
if __name__ == "__main__":
    ...
    dataset_dir = '/data/Argoverse/argoverse-tracking/val'
    d_min = 0
    d_max = 100
    ...
    exp_name = f'val-track-preds-KF-city-frame-maxage'
    ...
    tracker_output_dir = f'/home/ee904/SDC_lecture/hw5_noetic_ws/src/argoverse_cbgs_kf_tracker/temp_files/val-split-track-preds-maxage15-minhits5-conf0.3'
