...
icp_localization::icp_localization()
{
  ...
  nh.getParam("/ICP_localization_1_2/result_save_path", result_save_path);
...
pcl::PointCloud<pcl::PointXYZI> icp_localization::downSample(const sensor_msgs::PointCloud2 &msg)
{
  ...
  sor.setFilterLimits(-10.0, 10.5);
  sor.setLeafSize (0.15f, 0.15f, 0.6f);
  sor.filter (*cloud2);
...
void icp_localization::cb_matching(const sensor_msgs::PointCloud2 &msg)
{
  ...
  sor.setFilterFieldName("z");
  sor.setFilterLimits(-8, 8.5);
  sor.setLeafSize (0.15f, 0.15f, 0.5f);
  ...
  icp.setMaximumIterations (1500);              //最大迭代次數
